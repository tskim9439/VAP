...
hf)
  ...
  conda activate "$ENV"
  pip install -U transformers accelerate huggingface_hub soundfile librosa python-dotenv datasets einops matplotlib soxr peft jiwer "num2words==0.5.14"   # num2words: textnorm v1.0 고정
