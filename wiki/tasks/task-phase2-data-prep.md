...
## 진행 기록
- 2026-09-18 (16): **D1b 학습 완료·샘플 추론**(잡 72504). 실제 산출물 `/soundai/Model/VAPASR/p2-D1b-restart/final`, 12,040 step, encoder 포함 재로드 parity 통과(모델 321키·encoder 638키 값 차이 0). 미학습 NIKL/CHiME 각 1창 free-running 진단과 청취 뷰어 → [[output-phase2-d1b-sample-inference]]. NIKL pooled CER 12.5%이나 2 ref episode→22 hyp로 과분할·후반 화자 오귀속, CHiME-6 WER 150% 실패. 전체 평가 전 결론 금지.
