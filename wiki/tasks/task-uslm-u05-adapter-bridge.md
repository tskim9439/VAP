...
- [x] **관문 재정의·통과(2026-09-04, 사용자 결정)**: 새 관문 = 동일 인코더 RNN-T `[56,0]` 보다 우수(충족, −6~−9 pt) + 오프라인 Qwen 대비 ≤ +50 % 상대(충족, +9~+35 %). backbone 유지, U1 착수. 보고서 [[output-uslm-u05-adapter-bridge]]. 인코더 상위 블록 unfreeze 는 U1 ablation 으로 이월.
