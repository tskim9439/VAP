...
|---|---|---|---|
| KO | 71631 원본 248 h + 134-1 실외 344.2 h = **≈593 h** | 186 복지 콜센터(발화 30,661), 132 연령대별 대화(≈수백 h 추정) | 134-1 실내 부분, 134-2 청소년(최대 수천 h), NIKL 준용 |
...
| 청소년 71632 | (zip 라벨 집계 중) | | | | 134-2 조각 실내 1,755,051 파일 / 7,821 대화, 실외 417,170 / 1,649 대화 |
...
- 청소년은 라벨이 zip 안에 있어(`NIA24/134-2/Json/*.zip`, `aihub/71632`) 압축을 풀지 않고 읽어 집계 중이다. 조각 파일 수(2.17 M)가 성인 훈련 발화 수(2.84 M)와 비슷한 규모라 보유율이 높을 가능성이 있다.
## 불확실성
