...
| NIA23 186 복지 콜센터 발화 파일 | 화자 유형(상담사/고객)별 파일, 스마트폰·집 녹음 → 화자별 녹음으로 보임(**확인 중**) | JSON 30,661 | 통화 시간축 없음 → 준자연 스트림 | 있음 | 확인되면 준자연 2 자 통화 |
| raw/132 연령대별 대화 발화 | 발화 단위 mono, 화자별 녹음 여부 **확인 중** | 297 폴더 | 없음 → 준자연 | 있음 | 확인 후 |
...
|---|---|---|---|
| KO | 71631 원본 248 h + 134-1 실외 ≈360 h = **≈610 h** | 186 콜센터(확인 중), 132(확인 중) | 134-1 실내 부분, 134-2 청소년(최대 수천 h), NIKL 준용 |
