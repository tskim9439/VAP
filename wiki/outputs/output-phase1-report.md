...
| C2 · test(표본) δ=4 | 0.058 | 0.123 | 0.187 / 0.196 | 0.385 |
...
**미결·이월**
1. test 셋 보고: δ=2 표본 test(s300/u1000) 반영 완료(E2 0.082 / 0.139 / 0.158 / 0.184, dev 와 ±0.02 이내). E2 δ=4 표본 test 반영 완료(0.054 / 0.107 / 0.125 / 0.136). C2 δ=4 표본 test 반영 완료(0.058 / 0.123 / 0.187 / 0.196). 전체 셋(SLURM)은 추가 예정.
